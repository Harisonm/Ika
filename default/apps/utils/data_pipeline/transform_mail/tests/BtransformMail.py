...
from default.apps.utils.data_pipeline.transform_mail.manager.TransformMailManager import TransformMmailManager
...
SCHEMA = "default/apps/utils/data_pipeline/transform_mail/resources/schema/gmail_fields.json"
PATH_SAVE = "b_transform_gmail/"

"""
Usage:
python -m default.apps.utils.data_pipeline.transform_mail.BtransformMail
"""


def main(name_file):
    begin_time = time.time()
    env_path = Path('default/apps/utils/data_pipeline/transform_mail/.env')
